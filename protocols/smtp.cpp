...
void service_smtp(char *ip, int32_t sp, unsigned char options, char *miscptr, FILE *fp, int32_t port, char *hostname) {
  ...
  char *buf;
  char *buffer1 = "EHLO fpassword\r\n";
  char *buffer2 = "HELO fpassword\r\n";
    ...
    case 1: /* connect and service init function */
      ...
      if (verbose) {
        ...
        case AUTH_LOGIN:
          ...
          break;
        case AUTH_PLAIN:
          fpassword_report(stderr, "[VERBOSE] using SMTP PLAIN AUTH mechanism\n");
          break;
#ifdef LIBOPENSSL
        case AUTH_CRAMMD5:
          fpassword_report(stderr, "[VERBOSE] using SMTP CRAM-MD5 AUTH mechanism\n");
          break;
        case AUTH_DIGESTMD5:
          fpassword_report(stderr, "[VERBOSE] using SMTP DIGEST-MD5 AUTH mechanism\n");
          break;
#endif
        case AUTH_NTLM:
          fpassword_report(stderr, "[VERBOSE] using SMTP NTLM AUTH mechanism\n");
          break;
        }
      }
      free(buf);
