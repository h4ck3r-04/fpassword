...
int32_t start_xmpp(int32_t s, char *ip, int32_t port, unsigned char options, char *miscptr, FILE *fp)
{
  ...
  fpassword_send(s, buffer, strlen(buffer), 0);
  usleepn(300);
    ...
    case 1: /* connect and service init function */
      ...
      if (verbose)
      {
        ...
        case AUTH_LOGIN:
          ...
          break;
        case AUTH_PLAIN:
          fpassword_report(stderr, "[VERBOSE] using XMPP PLAIN AUTH mechanism\n");
          break;
#ifdef LIBOPENSSL
        case AUTH_CRAMMD5:
          fpassword_report(stderr, "[VERBOSE] using XMPP CRAM-MD5 AUTH mechanism\n");
          break;
        case AUTH_SCRAMSHA1:
          fpassword_report(stderr, "[VERBOSE] using XMPP SCRAM-SHA1 AUTH mechanism\n");
          break;
        case AUTH_DIGESTMD5:
          fpassword_report(stderr, "[VERBOSE] using XMPP DIGEST-MD5 AUTH mechanism\n");
          break;
#endif
        }
      }
